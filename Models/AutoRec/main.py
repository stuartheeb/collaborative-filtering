...
data_name = 'cil'; num_users = 10000; num_items = 1000; num_total_ratings = 1176952; train_ratio = 0.9
...
print('np.sum(train_mask_R) = ' + str(np.sum(train_mask_R)))

print('test_R.shape = ' + str(test_R.shape))
print('np.sum(test_mask_R) = ' + str(np.sum(test_mask_R)))
